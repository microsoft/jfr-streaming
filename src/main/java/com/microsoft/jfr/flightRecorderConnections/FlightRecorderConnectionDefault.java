...
import com.microsoft.jfr.JfrStream;
 ...
 *
 */
public class FlightRecorderConnectionDefault implements FlightRecorderConnection {
     ...
     */
    public static FlightRecorderConnectionDefault connect(MBeanServerConnection mBeanServerConnection)
        ...
        try {
            ...
            return new FlightRecorderConnectionDefault(mBeanServerConnection, objectInstance.getObjectName());
    ...
    private FlightRecorderConnectionDefault(MBeanServerConnection connection, ObjectName objectName) {
